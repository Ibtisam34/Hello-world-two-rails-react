...
# 📖Hello-world-two-rails-react   <a name="about-project"></a>


**Hello-world-two-rails-react**  is a hello world app that display hello world in differents languages
...
```sh
  git https://github.com/Ibtisam34/Hello-world-two-rails-react.git
```
